...
tasks = [
    ...
    {"corpus": "DrBenchmark/ESSAI", "subset": None, "dataset": None, "data_path": "./recipes/essai/data/", "task": 1},
    {"corpus": "DrBenchmark/CAS", "subset": None, "dataset": None, "data_path": "./recipes/cas/data/", "task": 1},
    {"corpus": "DrBenchmark/ESSAI", "subset": None, "dataset": None, "data_path": "./recipes/essai/data/", "task": 2},
    {"corpus": "DrBenchmark/CAS", "subset": None, "dataset": None, "data_path": "./recipes/cas/data/", "task": 2},
...
for subset in ["train","validation","test"]:
    ...
    for task in tasks:
        ...
        for e in dataset:
            ...
            if (task["corpus"].lower().find("essai") != -1 or task["corpus"].lower().find("cas") != -1) and task["task"] == 1:

                label_list = dataset.features["pos_tags"][0].names
                current_classes = [label_list[n] for n in e['pos_tags']]
            
            if (task["corpus"].lower().find("essai") != -1 or task["corpus"].lower().find("cas") != -1) and task["task"] == 2:
